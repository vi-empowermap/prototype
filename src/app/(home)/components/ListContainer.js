...
const ListContainer = ({turnOnMap, doubleScreenTouched, getData, bundeslandtext }) => {
  ...
  return (
    <div id="listContainer" className={`relative w-full bg-white lg:border-l-2 border-black lg:max-w-[calc(200px+20vw)] ${!doubleScreenTouched ? "h-1/2" : "h-[100px]"} lg:h-screen z-[1300] ${turnOnMap ? "block" : "hidden"}  ${ready ? "opacity-100": "opacity-0"}`}>
