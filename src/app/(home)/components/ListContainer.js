...
const ListContainer = ({ doubleScreenTouched, getData }) => {
  return (
    <div id="listContainer" className={`relative w-full bg-white lg:border-l-2 border-black lg:max-w-[calc(200px+20vw)] ${!doubleScreenTouched ? "h-1/2" : "h-[200px]"} lg:h-screen z-[1300]`}>
      <div className={`absolute top-0 lg:-left-8 w-full lg:max-w-[calc(200px+20vw)] ${!doubleScreenTouched ? "h-full" : "h-[200px]"} lg:h-screen pt-20 relative overflow-y-scroll z-[1300] no-scrollbar`}>
