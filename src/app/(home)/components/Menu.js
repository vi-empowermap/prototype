...
const Menu = () => {
  ...
  return (
    <div className="h-full px-2 flex justify-center items-center cursor-pointer hover:bg-black hover:text-white transition-all relative z-[1300] group select-none font-jetBrainsMono font-medium border-none border-black stroke-black hover:stroke-white">
